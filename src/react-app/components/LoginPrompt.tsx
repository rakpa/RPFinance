      ...
      <div className="max-w-md w-full">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Your AI-powered expense tracker with smart insights
          </p>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-center gap-3 p-4 bg-emerald-50 rounded-xl">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-600">Get personalized spending tips</p>
              </div>
            </div>
          ...
          <p className="text-xs text-gray-500 mt-4">
            Sign in to start tracking your expenses and get AI-powered insights
          </p>
        </div>
      </div>
    </div>
